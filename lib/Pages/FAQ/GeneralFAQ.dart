...
List<MyTile> listOfTiles = <MyTile>[
  ...
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​Unless stated otherwise for a specific diploma/course (ex: Pro-Green Diploma), in general, regular attendance in classes, lectures, labs, and seminars is mandatory to qualify for graduation with a degree from AUB.  No distant learning or online degrees are offered at AUB."),
    ],
  ),
  new MyTile(
  ...
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​All courses are taught in the English language except Arabic courses.")
    ],
  ),
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​There are six residence halls on campus (four for women and two for men) in addition to one off campus (for women). For more information, please contact the Office of Student Housing at http://www.aub.edu.lb/sao/housing/")
    ],
  ),
  new MyTile(
  ...
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​You may request to postpone your acceptance by one term; by replying to your acceptance email and requesting it.  We will review your request and provide you feedback or confirmation regarding your postponement request.")
    ],
  ),
  new MyTile(
  ...
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​AUB does not email students about this petition process because this may not apply to every applicant. However, accepted undergraduate students have up to one month before their enrollment confirmation deadline to petition for consideration to other majors")
    ],
  ),
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "​Please refer to our acceptance page for details on the communications we send to our accepted students: http://www.aub.edu.lb/admissions/acceptances/")
    ],
  ),
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "IELTS can be considered to satisfy the AUB English language requirement.  The required IELTS minimum scores or additional requirements can be viewed at https://www.aub.edu.lb/admissions/english/")
    ],
  ),
  new MyTile(
    ...
    <MyTile>[
      new MyTile(
          "Undergraduate applicants are only notified of their acceptance and hence rejection letters are not sent to applicants.  ​Graduate applicants will be notified of their acceptance or rejection.")
    ],
  ),
];
